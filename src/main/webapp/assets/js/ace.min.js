...
"ace" in window || (window.ace = {}), "helper" in window.ace || (window.ace.helper = {}), "options" in window.ace || (window.ace.options = {}), "vars" in window.ace || (window.ace.vars = {
    ...
    function t(a, t, n) {
        ...
        if (e(document).trigger(r = e.Event("ajaxloadstart"), {
            ...
            v.css("opacity", .25);
            var p = e('<div style="position: fixed; z-index: 2000;" class="ajax-loading-overlay"><i class="ajax-loading-icon fa fa-spin ' + o + '"></i>  <span style="color:#ff892a;font-size:13px;position:relative;top:-3px">Loading...</span>' + l + "</div>").insertBefore(v),
                f = v.offset();
            /*alert("show")*/
            p.css({
                top: f.top,
